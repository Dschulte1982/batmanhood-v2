      ...
      <div className="stock-page">
          ...
          <div className="company-details-container">
            ...
            <div className="company-details">
              ...
              <div>
                ...
                <a href={companyData.weburl} id="weblink">
                  {" "}
                  {companyData.weburl}
                </a>
              </div>
        ...
        <div className="stock-buy">
          ...
          <button
            ...
            style={
              !inWatchlist
                ? { color: "#03C805", border: "1px solid #03C805" }
                : { color: "#FF5103", border: "1px solid #FF5103" }
            }
          >
