        ...
        valuesArray.push(
          <div key={values.indexOf(value)} className="stock-portfolio-list">
            <div className="stock-ticker-container">
              ...
              <span className="stock-ticker-list">{ticker}</span>
            </div>
            <div className="stock-number-container">
              <span className="stock-number-shares">Number of Shares:</span>{" "}
              <span className="stock-share-list">{share[0]}</span>
            </div>
          </div>
        );
      });
          ...
          <div className="nav-bar">
            <nav>
              <ul className="nav-list">
                ...
                <li id={"account-drop-down-li"} hidden>
                  <AccountDropDown user={this.props.user}></AccountDropDown>
                </li>
                <li>
                  <NavLink
                    to="/"
          ...
          <div id="profile-master-container">
            ...
            <div id="profile-add-balance-container">
              <div id="profile-add-balance">
                <div id="profile-add-balance-header">
                  Add to Your Vigilante Funds:
                </div>
                <input
                  id="profile-add-amount"
                  type="number"
                  min="0"
                  max="100000000"
                  step="0.01"
                ...
                ></input>
                <button
                  id="profile-add-balance-button"
                  onClick={balanceTotal}
                >
                  Add
                </button>
              </div>
            ...
            <div id="portfolio-master-container">
              <div id="owned-stocks-container">
                <ul id="owned-stocks-list">{stockLoader()}</ul>
              </div>
            </div>
          </div>
        </div>
